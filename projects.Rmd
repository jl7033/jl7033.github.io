...
### Table of Contents
- [Exploring DNA Methylation in Breast Cancer (TCGA-BRCA)]({#dna-methylation-brca})
- [Longitudinal Analysis of D-Penicillamine in Patients with Primary Biliary Cirrhosis](#long-anal-pbc)
- [Building Machine Learning Models to Predict Incidence of Severe Flu](#machine-learning-flu)
...
#### 1. Exploring DNA Methylation in Breast Cancer (TCGA-BRCA) {#dna-methylation-brca}

![](Plots/dna_methylation_volcano_plot.png){height=300px style="display:block; margin:0 auto;"}
...
#### 2. Longitudinal Analysis of D-Penicillamine in Patients with Primary Biliary Cirrhosis {#long-anal-pbc}

![](Plots/bili_spaghetti.png){height=300px style="display:block; margin:0 auto;"}
...
#### 3. Building Machine Learning Models to Predict Incidence of Severe Flu {#machine-learning-flu}

![](Plots/flu_cv_auc.png){height=300px style="display:block; margin:0 auto;"}
